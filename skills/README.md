...
| [Context and Memory Engineering Skill Pack](context-memory-engineering/) | Sets write gates, retrieval budgets, and prompt-placement rules for Open Brain-backed agent systems | [@jackrosenkranz](https://github.com/jackrosenkranz) |
